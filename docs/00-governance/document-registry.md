...
| ADR-014 | Motor de Regras de Reposição (configurável) | 🟡 Proposed | `docs/17-adr/ADR-014-replenishment-rules-engine.md` |
...
| Motor de Regras de Reposição — sugestão revisável já no MVP do MMS-004 vs. integralmente na v1.1/v2.0; catálogo inicial de políticas de quantidade | ARC-007 (P1 #20), ADR-014 | Em análise — ADR-014 registrada como Proposed, aguardando aceite do owner |
