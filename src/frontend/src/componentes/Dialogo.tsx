 ...
 */
export function Dialogo({ titulo, children, acoes, aoFechar, largura = 'max-w-[520px]' }:
  { titulo: string; children: ReactNode; acoes?: ReactNode; aoFechar: () => void; largura?: string }) {
