namespace TrinoSupply.BuildingBlocks;

/// <summary>
/// Resultado tipado de operação de aplicação/domínio (ARC-004 §7).
/// Erros de negócio são representados como <see cref="Error"/>, nunca exceções de controle de fluxo.
/// </summary>
...
public sealed class Result<T> : Result
{
    ...
    /// <summary>Valor do resultado; lança se acessado em falha.</summary>
