...
class HealthController {
  @Get()
  health() {
    return { status: 'ok', servico: 'trino-platform-api', fase: 'F4' };
  }
}

@Module({
  imports: [PrismaModule, AuthModule, UsuariosModule, CatalogoModule, FornecedoresModule, AprovacoesModule, RequisicoesModule],
